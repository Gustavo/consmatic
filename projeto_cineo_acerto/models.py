...
from ic_ec.models.projetoatividade import Projeto 
...
class Variavel(models.Model):
    ...
    atributo = models.ForeignKey(Config_Atribut_ATTR, blank= 'True', null='True')   #,related_name= 'remissao
    #models.ForeignKey(Config_Atribut_ATTR, blank= 'True', null='True')
    #config_atrib = models.ManyToManyField(Projeto, blank= 'True', null='True',through="Atrib_Termo") 
    nome =  models.CharField(max_length=50)
    ...
    def __unicode__(self):
        return    self.nome  + ' / '+ self.atributo.nome + ' / ' + unicode(self.sequencia)  #----------------------------------------------
...
#class Atrib_Termo(models.Model):
#    atributo = models.ForeignKey(Variavel, blank= 'True', null='True')
#    desc1= models.CharField(max_length=06, blank= 'True', null='True')
#    projeto = models.ForeignKey(Projeto, blank= 'True', null='True')
#    desc2=models.CharField(max_length=06, blank= 'True', null='True')
...
#     nome = models.CharField('Entrada - termo ou fraseologismo:', max_length=150)
     ...
     #Tipo do Termo ( ou Fraseologismo). Por enquanto, o domínio é:  TRM - Termo; FRA - Fraselogismo; ESP - Especialidades Conscienciológicas; ELD - ELDICT) 
     ...
     ### Os seguintes attrs saem da classe básica de Terminologia (TERMoS), passando para a CLASSE das VARIÁVEIS:
     #**********************************************************
     Dominio_Status_Termo= (
        ('Nor', 'Normal'),
        ('Neo', 'Neologismo'),
        )
     status_termo= models.CharField('Status do termo',default='Nor',max_length=03,choices=Dominio_Status_Termo,blank='True')
     ...
     termos_equivalentes = models.ManyToManyField("self",blank= 'True', null='True') #,related_name= 'traducao'
     ...
     remissiva = models.ManyToManyField("self", blank= 'True', null='True')   #,related_name= 'remissao
     #'Remissivas:',
...
class Entrada(models.Model):
     ...
     #atrib_termo = models.ForeignKey(Atrib_Termo)#Variavel)
     variavel = models.ForeignKey(Variavel, null='true'   )#Variavel)
...
#    autor = models.CharField(max_length=400)
     ...
     def __unicode__(self):
     #    if unicode(self.variavel.nome) is not None: return  unicode(self.variavel.nome)  #atributo + '/    ' + self.atrib_termo.projeto # + ' /    ' + self.termo.nome ' /      '  
         ##return '%s' % self.atrib_termo.atributo
         return unicode(self.variavel.nome) #or u''
         ##return '%s' % self.atrib_termo.projeto
         ##return unicode(self.atrib_termo.desc2) #or u''
...
#        return self.atividade.nome    + " / " + self.assocconscic_ec.consc.nome  + " / "   +  self.atividade.inicio
     ...
     class Meta:
         #ordering = ["sequencia"]
         verbose_name = "CAMPO"#FICHA do TERMO ou FRASEOLOGISMO CONSCIENCIOLÓGICO:"
         verbose_name_plural = "FICHA TERMINOLÓGICA"#  CONSCIENCIOLÓGICO:" 
